...
@php
    ...
    switch ($variant) {
        ...
        break;
        case 'secondary':
            $variantClasses = 'bg-blue-500 text-white hover:bg-blue-400 focus:ring-gray-200 dark:text-gray-400 dark:bg-dark-eval-1 dark:hover:bg-dark-eval-2 dark:hover:text-gray-200';
        break;
        case 'success':
