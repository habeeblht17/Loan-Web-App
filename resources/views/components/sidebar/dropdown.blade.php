...
<div class="relative" x-data="{ open: @json($active) }">
    ...
    <div x-show="open && (isSidebarOpen || isSidebarHovered)" x-collapse>
        <ul
            class="relative px-0 pt-2 pb-0 ml-5 before:w-0 before:block before:absolute before:inset-y-0 before:left-0 before:border-l-2 before:border-l-blue-300 dark:before:border-l-gray-600">
