...
@php
    $isActiveClasses =  $isActive ? 'text-white bg-blue-800 shadow-lg hover:bg-blue-700' : 'text-white hover:text-gray-200 hover:bg-blue-400 dark:hover:text-gray-300 dark:hover:bg-dark-eval-2';
