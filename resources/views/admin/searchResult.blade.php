            ...
            <div class="p-4 bg-violet-50 dark:bg-dark-eval-1">
                <div class=" w-full">
                    <div class="flex flex-col justify-between md:flex-row">
                        <div class="w-1/2">
                            <h1 class="p-1 text-xl text-gray-500 dark:text-gray-100 font-semibold">Expenses Result</h1>
                        </div>
                    </div>
                    <!-- Expenses result -->
                    <table class="w-full rounded-lg bg-violet-50 dark:bg-dark-bg">
                        ...
                        <tbody class="-full divide-y divide-gray-300">
                            @foreach ($results as $result)
                                <tr class="">
                                    <td class="p-3 text-sm text-center font-semibold  text-gray-400">{{ $result->id }}</td>

                                    <td class="p-3 text-sm text-center font-semibold  text-gray-400">{{ $result->expense_amount }}</td>
